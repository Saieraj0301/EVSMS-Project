...
<div class="row justify-content-center">
          ...
          <div class="col-xl-6 col-lg-5 pt-5 pt-lg-0" >
            ...
            <br>
             <form action="EVbunkServlet" method="post" >
           
          <input type="text" name="bunklocation" class="form-control" id="bunklocation"   placeholder="Enter your location" required>
          <br>
          <input type="text" name="bunkarea" class="form-control" id="bunkarea"   placeholder="Enter your  Area" required>
          <br>
           <input type="text" name="slot" class="form-control" id="slot"   placeholder="Enter Number of Slots" required> <br>
           <input type="text" name="capacity" class="form-control" id="capacity"   placeholder="Enter slot capacity" required> <br>
           <input type="text" name="chargetime" class="form-control" id="chargetime"   placeholder="Minimum Charge Time" required> <br>
...
<input type="text" name="bankholdername" class="form-control" id="bankholdername"   placeholder="Enter bank holdername" required>
          ...
          <input type="text" name="email" class="form-control" id="uname"   placeholder="abc@gmail.com" required> <br>
            ...
            <div class="text-center">
             <button type="submit"  class="button" >Book</button> <!-- <a href="UserLogin.jsp" class="get-started-btn scrollto">Login</a>
