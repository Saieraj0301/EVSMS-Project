      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row justify-content-center">
          ...
          <br>
           ...
           <textarea name="address" rows="3" class="form-control" id="address"   placeholder="Enter Your Address( mention your full address (state/district/pincode)" required></textarea><br>
