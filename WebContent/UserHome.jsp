...
<!-- <div class="col-lg-8 "> -->
         ...
         <!--  <form action="SearchServlet" method="post">
                ...
                <div class="col form-group" >
                  <input type="text" class="form-control" name="bunkarea" id="bunkarea" placeholder="enter your area" required>
                </div>
              </div>
...
<br><br><br>
              <h3 class="sidebar-title">EV charging station details are below:</h3>
